...
public class QuestionResource {
	...
	@Path("/delQ")
	@Produces(MediaType.APPLICATION_JSON)
	public Response delQuestion(@RequestBody Question question) throws URISyntaxException {
		// delete a question
		dao.delete(question);
	...
	@Path("/loadQ")
	@Produces(MediaType.APPLICATION_JSON)
	public Response loadNextQuestion(@QueryParam("id") String id) {
		// load a question
		List<Question> searchList = dao.loadNextQuestion(new Question(id));
		return Response.ok(searchList).build();
	}
